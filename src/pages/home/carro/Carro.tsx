...
function Carro() {
  return (
    <>
      {/* 1° Bloco */}
      <div className="bg-gradient-to-r from-green-300 to-blue-400 flex justify-center">
      ...
      <div className="bg-gradient-to-r from-green-300 to-blue-400 flex justify-center">
        <div className="text-white text-center p-8">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <img className="w-28 h-24" src="logos/titanium.png" alt="Titanium" />
  ...
  <div className="container grid grid-cols-2 items-center text-white gap-8 p-8">
    <div className="text-left">
      <h2 className="text-4xl font-bold mb-6">
        <span className="text-blue-500">Seguros</span> com tecnologia, rapidez e zero burocracia.
      </h2>
      <p className="text-2xl mb-4">
      ...
      <div className="flex items-center gap-4 mb-4">
        <img src="https://cdn-icons-png.flaticon.com/128/7139/7139883.png" alt="Chave sendo inserida em um cadeado" className="w-12 h-12" />
        <p className="text-2xl">Com proteção</p>
      </div>

      <p className="text-2xl mb-4">Tranquilidade e confiança pro seu dia a dia.</p>

      <div className="flex items-center gap-4 mb-4">
        <img src="https://cdn-icons-png.flaticon.com/128/284/284128.png" alt="Homem deitado em um pato inflável na água" className="w-12 h-12" />
        <p className="text-2xl">Faça tudo online</p>
      </div>

      <p className="text-2xl mb-4">Contratar, acionar ou falar com a gente é muito fácil.</p>

      <div className="flex items-center gap-4 mb-4">
        <img src="https://cdn-icons-png.flaticon.com/128/2097/2097276.png" alt="Mulher alterando as configurações de um sistema" className="w-12 h-12" />
        <p className="text-2xl">Personalize</p>
      </div>

      <p className="text-2xl mb-4">Escolha o plano ou formato e pague um valor justo.</p>

      <div className="flex items-center gap-4">
        <img src="https://cdn-icons-png.flaticon.com/128/1611/1611261.png" alt="Coelho competindo em uma corrida com uma barra de carregamento" className="w-12 h-12" />
        <p className="text-2xl">No seu tempo</p>
      </div>

      <p className="text-2xl mt-4">Agilidade e facilidade sem aqueles prazos enormes.</p>
    </div>
    ...
    <div className="flex justify-center">
      ...
      />
        ...
        {/* nosso contato */}
        <div className="bg-gradient-to-r from-green-300 to-blue-400 flex justify-center py-8">
  <div className="container text-white text-center">
    ...
    <div className="mb-4">
      ...
      <p className="text-lg">Das 9h às 18h, de 2ª a 6ª</p>
    </div>
