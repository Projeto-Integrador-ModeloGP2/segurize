...
function CardSeguradoras({ seguradora }: CardSeguradoraProps) {
  ...
  return (
    <div className="flex justify-center my-4 ">
      <div className="border flex flex-col rounded-2xl overflow-hidden w-80 bg-[#b1c8dd]">
        {/* Header com o título */}
        <header className="py-2 px-6 bg-[#0A0A3C] text-white font-bold text-2xl text-center">
          <h1>{seguradora.nome}</h1>
        </header>

        {/* Especialidade da seguradora */}
        <p className="p-4 text-xl bg-[#b1c8dd]">
        ...
        <div className="flex items-center justify-end px-4">
          ...
          <Link
            ...
            className="w-10 h-10 rounded-full bg-red-600 hover:bg-red-500 flex items-center justify-center m-1"
          >
